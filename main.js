...
const HABILIDADES_DESC = {
  ...
  'Wrestling Intermediário': 'O Linebacker detém um domínio técnico intermediário na luta agarrada, herança de seus treinos intensivos nos tapetes da escola. Ele é capaz de aplicar quedas precisas e torções simples com fluidez, além de conseguir se movimentar e transicionar posições no chão com extrema facilidade.',
  ...
  'Atleta de Elite': 'Dotado de um físico imponente, você se destaca como um dos mais formidáveis atletas de Bullworth Academy, sendo amplamente reconhecido como o herdeiro direto à sucessão dos Bullhorns. Com seus impressionantes 1,90m de altura e uma robustez notável, apresenta força e resistência excepcionais. Uma vez por combate, ao sofrer um golpe que o levaria ao nocaute, seu corpo suporta o impacto, permitindo-lhe manter-se consciente enquanto reduz significativamente os danos recebidos. Pode percorrer até cinco quadrados por turno quando não está engajado em combate direto.',
  'Wrestling Avançado': 'Exímio na arte do wrestling, você detém um domínio avançado desta modalidade, sendo um dos poucos em Bullworth Academy capazes de competir nesse nível, rivalizando até mesmo com o capitão dos atletas. Reconhecido como o Executor dos Atletas, sua presença em combate impõe temor imediato. Seu estilo incorpora quedas explosivas e brutais, com destaque para seu movimento de assinatura: o suplex. Uma vez por combate, pode executar um suplex poderosíssimo, capaz de desacordar instantaneamente o adversário se bem-sucedido.',
  'Investida Implacável': 'Dono de um instinto combativo apurado, você é capaz de identificar com precisão o momento exato de uma investida inimiga. Uma vez por combate, você pode antecipar um ataque direto, projetando-se contra as pernas do adversário em uma entrada explosiva, executada com violência, precisão e domínio corporal absoluto. Se bem-sucedida, a técnica leva o adversário imediatamente ao chão, concedendo domínio posicional instantâneo.',
  'Prodígio dos Atletas': 'Um verdadeiro prodígio entre os Bullhorns, você se destaca como o terceiro na linha de comando, combinando força, resistência e desempenho atlético de alto nível. Com seus 1,80m de altura, é um dos atletas mais proeminentes do grupo. Capaz de percorrer até cinco quadrados por turno, figura como o terceiro mais rápido do time. Uma vez por combate, pode desferir um golpe de impacto elevado, capaz de desorientar calouros, veteranos comuns e tenentes por um turno inteiro.',
  'Taco de Alumínio': 'Como símbolo de prestígio entre os atletas, você detém posse de um taco de alumínio autografado. Este armamento só pode ser empregado dentro do território dos atletas, sendo permitido em outras áreas apenas em contextos de guerra. Quando utilizado, o taco pode ser manejado por até 4 turnos. Seus golpes são extremamente danosos, desferidos com força suficiente para tornar o bloqueio convencional inviável, sendo, portanto, apenas esquiváveis.',
  'Touro de Bullworth': 'Sua identidade permanece como um verdadeiro segredo. Como integrante do time, possui conhecimento intermediário em wrestling, além de percorrer até cinco quadrados por turno. Sua fantasia de mascote funciona como uma verdadeira armadura, capaz de absorver impactos variados. Suporta até seis golpes antes de ser comprometida; os três primeiros impactos são completamente anulados, enquanto os três subsequentes têm o dano reduzido pela metade.',
  'Fúria do Touro': 'Incorporando a força bruta que simboliza, você investe contra o adversário em uma cabeçada devastadora, projetando-o diretamente ao solo caso a carga seja bem-sucedida. A violência da investida desestabiliza completamente o alvo, que permanece desorientado por um turno inteiro. Esta habilidade pode ser utilizada uma vez por combate.',
  'Maluco do Pedaço': 'Você encarna plenamente a personalidade do mascote, assumindo um comportamento imprevisível, irreverente e provocador. Especialista em pegadinhas e ações oportunistas, você não hesita em recorrer a táticas pouco convencionais para obter vantagem. Uma vez por combate, pode utilizar um dos seguintes itens especiais: saco de bolinhas de gude, bomba de fedor ou firecracker.',

  // ============================================================
  // BULLIES - HABILIDADES EXCLUSIVAS
  // ============================================================
  'Colossal': 'Sua constituição não é brincadeira para ninguém. Medindo incríveis dois metros e quinze, sua estrutura física é incomparável no quesito pujança física. Consegue uma vez por combate desferir um ataque capaz de nocautear uma pessoa se atingir diretamente a cabeça. Por conta do grande peso corporal, sua corrida é de meros três quadrados por turno. Calouros e veteranos comuns necessitam de aplicar o dobro de danos para nocautear o líder dos valentões. O líder se torna imune às primeiras tentativas de o derrubar no chão.',
  'Até-o-último-cuecão': 'Quando enraivecido, perde completamente o controle da racionalidade e se impõe no mundo como uma besta fora da jaula. No período de 3 turnos, aplica golpes tão poderosos que consegue romper completamente guardas. Caso esteja beirando o nocaute, consegue estender sua permanência em combate por 3 turnos, perdendo momentaneamente a percepção de dor. Logo após é forçado a perder a consciência, mas apenas no caso de estar prestes a ser nocauteado.',
  'Aura e Ego': 'Diante uma figura tão alta, tão poderosa fisicamente, em posição de liderança, você exala uma aura que torna todas as pessoas suscetíveis a um medo imebriante. Durante o período de 1 turno, você é capaz de intimidar uma pessoa, fazendo com que ela congele de tanto temor. Esta habilidade só pode ser utilizada uma vez por combate. Calouros e veteranos comuns evitarão arrumar confusão ao máximo e são incapazes de mentir para o colosso dos bullies.',
  'Mestre da Trapaça': 'O vice-líder dos valentões é uma pessoa extremamente baixa, utilizando de artimanhas que ultrapassam até mesmo o que os próprios bullies acham sujo. Essa proficiência permite utilizar de golpes baixos sempre, sem limitação ou restrição, podendo abusar de táticas como golpes nas regiões baixas, atingir pontos sensíveis como os olhos e músculos. Consegue aplicar em um mesmo turno uma combinação de dois golpes baixos na mesma área ou em áreas distintas, com o cooldown de 1 turno.',
  'Guerreiro Urbano': 'O Grande Malandro é uma pessoa versada na arte de luta de rua. Essa mentalidade o forçou a se constituir como um guerreiro das ruas, tenaz e capaz de se impor diante de qualquer pessoa. Encontrou em objetos um potencial gigantesco de crescimento em batalha. É apto a utilizar qualquer objeto do quarto como uma arma. Seu estojo leva: três lápis, uma borracha grande e uma lapiseira.',
  'Bater e Fugir': 'Capaz de, em um único turno, percorrer 14 quadrados em uma corrida extremamente veloz. Desenvolveu seu estilo de luta próprio, podendo uma vez por combate desviar totalmente de um ataque se anteriormente tiver atingido o seu oponente. Não se trata de um "desvio" comum, é um distanciamento considerável de dois quadrados. Uma vez utilizada a tática em alguém, caso opte por se retirar de combate temporariamente e retornar, a habilidade não pode ser novamente utilizada.',
  'Semente do Mal': 'Consegue convencer calouros e veteranos comuns das mais cabeludas mentiras deslavadas, plantando uma verdadeira semente do mal, capaz de alimentar rumores, levantar suspeitas, irritar indivíduos. O tenente dos bullies é a única pessoa de todo o instituto a se manter imune a acusações, mentiras e manipulação da mídia.',
  'Festival de Pegadinhas': 'É a única pessoa em toda Bullworth que detém todo o arsenal não ofensivo para um único fim: pegadinhas. Artefatos que possam ser utilizados para este fim de humilhação ou depredação são as armas favoritas. A lista é vasta: cartela de ovos, grafite, tinta, pó de mico, bexigas, tachinhas, sabão líquido, óleo e outros.',
  'Mestre dos Disfarces': 'Dono de uma habilidade excepcional com maquiagem teatral e caracterização de figurinos, é capaz de criar disfarces extremamente convincentes. Permite emular a aparência facial, os trejeitos e até mesmo os padrões de voz de terceiros com enorme fidelidade. No entanto, características estruturais como altura, peso e porte físico geral não podem ser alteradas, sendo impossível replicar com sucesso a fisionomia de líderes ou vice-líderes das facções.',

  // ============================================================
  // GREASERS - HABILIDADES EXCLUSIVAS
  // ============================================================
  'Campeão de Muay Thai': 'Após longos anos de treinamento, conquistou um físico invejável e uma resistência semelhante a dos lutadores profissionais, suportando, uma vez por combate, golpes que poderiam nocauteá-lo. Seus golpes são mais rápidos do que qualquer aluno, superando até mesmo os seus tenentes com chutes tão velozes que parecem raios, além de cotoveladas e joelhadas que possuem a capacidade de cortar o oponente e fazê-lo sangrar em um único turno de contato, com exceção de outros líderes.',
  'Defesa Impenetrável': 'Suas canelas são tão duras quanto aço, forjados na dureza e na brutalidade de suas sessões de treinamento. Os anos de prática renderam ao Campeão das Ruas um nível de inteligência de luta extremamente alto, que se traduz em reflexos e bloqueios rápidos. Garante ao personagem três bloqueios absolutos por combate, permitindo anular por completo o impacto dos ataques recebidos, sem sofrer danos ou penalidades.',
  'Domínio das Pernas': 'Ágil o suficiente para disparar chutes na longa distância e acertar adversários sem que percebam. Seus chutes são tão rápidos que a velocidade se equipara a dos golpes do Campeão de Boxe. Duas vezes por combate, pode realizar uma sequência de dois chutes consecutivos, sendo livre para variar as áreas que deseja acertar. Caso acerte o mesmo local, o nocaute em calouros e até mesmo tenentes é certo, enquanto o restante perde 50% das capacidades onde for acertado.',
  'Peso-Pesado dos Greasers': 'Tratando-se de um colosso, possuindo 1,85 m de altura, ossos largos e densos e músculos enormes. Sua envergadura é uma das maiores da escola. Uma vez por combate, pode resistir a um golpe nocauteador. Adicionalmente, pode sobreviver a uma primeira tentativa de queda, toda vez que entra em combate, por conta de seu tamanho.',
  'Gigante do Muay Thai': 'Seus golpes são contundentes e devastadores à distância, mas igualmente poderosos a curta distância. Uma vez por combate, o Vice-Líder dos Greasers é capaz de desferir um soco com toda a força de seu corpo na cabeça de outro aluno, nocauteando-o caso acerte em cheio (com exceção de líderes e vice-líderes). Adquire um bloqueio extra, aparando um golpe imparável independentemente da situação do combate.',
  'Demolidor do Ferro Velho': 'Porta uma marreta de construção. O personagem só pode utilizar a marreta em situações de guerra ou dentro do território dos Greasers. Dois impactos diretos na cabeça são capazes de nocautear calouros; veteranos e tenentes necessitam de três pancadas; vice-líderes e líderes caem com quatro impactos. O uso desse armamento cobra um preço elevado do fôlego, só conseguindo empunhá-la por um período máximo de cinco turnos antes de ficar exausto.',
  'Lutador das Ruas': 'Iniciou seu caminho no submundo da luta de Bullworth através do Muay Thai, aperfeiçoando a arte de oito armas até um nível intermediário. Consegue, uma vez por combate, emplacar uma sequência de dois golpes: um soco e um chute, sendo o último na perna, que desestabiliza o adversário e o envia para o chão. Seu maior fator é a imprevisibilidade.',
  'Grappler da Oficina': 'Aperfeiçoado no ginásio de Bullworth em treinos conjuntos com os atletas. Uma vez por combate, é capaz de se lançar em uma queda, utilizando toda a força e o peso do corpo para arremessar o adversário no chão, causando atordoamento por um turno. Uma vez por luta, pode se defender de uma tentativa de queda, funcionando como um bloqueio adicional.',
  'Mestre do Clinch': 'Unindo ambas as qualidades do Muay Thai e do Wrestling, seus agarrões são extremamente difíceis de se defender. No clinch, o Grappler da Oficina não recebe golpes na cabeça devido a posição privilegiada. Pode, uma vez por combate, aplicar uma joelhada no clinch que, se assertiva, desorienta a vítima e a deixa atordoada por um turno inteiro.',

  // ============================================================
  // PREPPIES - HABILIDADES EXCLUSIVAS
  // ============================================================
  'Herança Aquaberry': 'Você representa não apenas uma das famílias ricas de Bullworth Town — você representa todas elas. Exalando uma aura de confiança, elegância e autoridade natural, sua presença impõe hesitação até mesmo nos mais preparados. O primeiro ataque direcionado contra você em combate tem sua eficácia reduzida. Uma vez por combate, você pode inspirar um aliado Preppy participante do confronto, permitindo que ele realize um ATAQUE DUPLO em seu turno.',
  'Punho de Ouro': 'Forjada como um verdadeiro artefato de status, a soqueira do líder Preppy é moldada em ouro maciço de alta densidade. O peso é distribuído com maestria, garantindo impactos devastadores sem comprometer a velocidade dos golpes. Duas vezes por combate, você pode executar um GOLPE CONTUNDENTE: um ataque direto, preciso e extremamente destrutivo. Caso conecte, é capaz de derrubar instantaneamente qualquer oponente de resistência comum. Contra alvos mais resistentes, o impacto os deixa severamente abalados.',
  ...
  'Destreza do Campeão': 'O campeão dos mauricinhos é o aluno mais ensaboado de todo o internato. Sua agilidade não vem apenas dos treinos milionários, mas de um talento natural. Tem duas esquivas para utilizar em sua rotação de ações. A cada uma rotação de evasivas, ganha o benefício de uma delas ser inesperada, praticamente impossível, sendo seguida de um contra-ataque implacável que garante um knockdown caso acerte em cheio.',
  'Soco de Diamante': 'Os socos do campeão são os mais fortes de toda a Bullworth. Duas vezes por combate, em um espaçamento de três turnos de diferença, tem direito ao Soco de Diamante. Caso acerte em cheio em uma região sensível, a lona é certa para quem recebê-lo. Em casos de defesa, o membro atingido ficará em desuso por dois turnos para calouros, veteranos e tenentes. Para líderes e vice-líderes, um turno de inutilidade do membro.',
  'Nobre Sequência': 'Esbanjar não se restringe a dinheiro. O Campeão ostenta o que é realmente importante: força e eficiência. Duas vezes por combate, com um intervalo de três turnos até o próximo uso, tem direito a uma sequência aniquiladora: três socos de uma vez só. Em calouros e veteranos, os três socos significam o nocaute. Em tenentes e vice-líderes, se convertem em um knockdown. Para líderes, os três socos são fatais e deixam sequelas que permanecem até o fim da luta.',
  'Postura Intocável': 'O kickboxer detém uma resistência e controle corporal admiráveis, fruto de treinos caríssimos. Desenvolveu uma resistência louvável que permite defender e absorver no corpo os mais variados tipos de golpe, garantindo uma defesa extra passiva a cada quatro turnos de combate. O uso da habilidade não influencia as tentativas de contra-ataque, permitindo que ele aja livremente.',
  'Chute Milionário': 'Seu chute alcançou um nível de potência excepcional. Caso um calouro ou tenente tente bloquear, o membro utilizado na defesa é inutilizado por dois turnos; vice-líderes, por um turno; líderes são exceção. Se atingir diretamente a cabeça, nocauteia um calouro ou tenente instantaneamente; vice-líderes ficam atordoados por um turno, enquanto líderes sofrem um dano absurdo. Só pode ser utilizado uma única vez por combate.',
  'Reflexo Luxuoso': 'A velocidade é uma das marcas registradas dos mauricinhos, um traço refinado que desperta a inveja de qualquer outra camarilha. O Kickboxer consegue realizar, uma vez por confronto, uma esquiva consecutiva perfeita, sem consumir sua ação defensiva inicial.',

  // ============================================================
  // NERDS - HABILIDADES EXCLUSIVAS
  // ============================================================
  'Portador da Spud Gun': 'A espingarda de batatas é uma lenda dentre os nerds, capaz de realizar oito disparos totais antes de ser recarregada. O alcance abrange dez quadrados. Um disparo nocauteia calouros e veteranos se atingir a cabeça; vice-líderes e tenentes são desorientados com um disparo; líderes menos resistentes precisam de três disparos; líderes bullie e jock precisam de quatro disparos na cabeça.',
  'O Temido Rocket Launcher': 'Utilizado somente em disputas territoriais. No alcance de 4 quadrados, uma única vez na guerra, libera três fogos de artifício que, se atingirem o alvo, imediatamente o nocauteiam. Somente os líderes bullie e jock são semi-nocauteados, já incapazes de agir posteriormente. A arma pode ser disparada no alcance de 4 quadrados de distância.',
  'Atirador de Elite': 'Pode arremessar firecrackers e bombas de fedor a quatro quadrados adicionais. Portador do Super Estilingue com luneta, alcance de doze quadrados. Calouros são nocauteados por quatro disparos consecutivos na cabeça; veteranos com seis; tenentes com seis; vice-líderes com sete; líderes greaser e preppie com oito; líderes bullie e jock com dez disparos na cabeça.',
  'Inovação Geracional': 'Você é uma pessoa bastante inteligente. Esta facilidade o permite elaborar criações autorais que podem se converter em armas de longa distância, armas de curta distância, trajes, entre outros. O vice-líder pode criar no máximo 4 criações autorais, sejam elas de uso pessoal ou para outros indivíduos.',
  'Régua de Eletrochoque': 'A cada 2 turnos de recarga, atinge pessoas com golpes de sua régua metálica projetando uma descarga elétrica potente. Calouros são nocauteados com duas descargas; veteranos são incapacitados com uma; líderes sofrem atordoamento leve. Os efeitos atordoantes perduram por 2 turnos. Após 4 golpes, precisa recarregar as baterias na base dos nerds ou em um eletrônico conectado à tomada por 3 turnos.',
  'Buginga-de-Última-Mão': 'Montou um pequeno aparelho portátil que se autodestrói, uma lâmpada minúscula de muitos lúmens que explode e cega temporariamente um alvo. Duração da cegueira é de 1 turno. Alcance para arremessar é de quatro quadrados. A lâmpada não fere fisicamente, apenas sobrecarrega os olhos temporariamente.',
  'Tempestade de Pum': 'Suas bombas de fedor conseguem ser ainda mais fedorentas, detendo um alcance maior ocupando 5x5 quadrados em área. Qualquer pessoa afetada imediatamente para o que estiver fazendo para se afastar dos gases. Apenas pode usar 2 bombas de fedor em sequência, precisando de 2 turnos para utilizar uma bomba ou sequência novamente.',
  'Super Firecracker': 'Carrega consigo o dobro de Firecracker comuns, desenvolvendo o Super Firecracker. Capaz de bombardear todos na área de 4x4. Potência capaz de nocautear imediatamente calouros; desnortear gravemente veteranos, incluindo tenentes; zonzear vice-líderes e líderes a ponto de não poderem atacar durante 1 turno.',
  'Poções Malucas': 'Com acesso irrestrito ao laboratório de química, pode utilizar dos recursos ali dispostos para produzir as bombas que preferir. O Sábio Alquimista tem direito a acrescentar 2 bombas ou poções com efeitos variados ao seu inventário pessoal; o uso somente será permitido com autorização prévia da organização.',

  // ============================================================
  // CHEERLEADERS - HABILIDADES EXCLUSIVAS
  // ============================================================
  'Rainha da Quadra': 'Seu corpo foi moldado durante anos de treinamento em ginástica, dança e cheerleading de alto rendimento. Capaz de percorrer até seis quadrados por turno quando não estiver engajada em combate direto. Sua excepcional consciência corporal impede que seja derrubada ou desequilibrada num primeiro golpe; sua primeira esquiva é sempre graciosa e precisa.',
  'Acrobata de Elite': 'Domina movimentos acrobáticos extremamente complexos. Duas vezes por combate, ao ser alvo de um ataque corpo a corpo ou de um projétil, pode executar uma evasão perfeita, anulando completamente o golpe. Após essa esquiva, pode reposicionar-se em até dois quadrados sem consumir sua ação do turno.',
  'Toda a Atenção para Mim': 'Uma vez por combate, transforma um confronto em um verdadeiro espetáculo. Durante dois turnos, todos os personagens presentes reconhecem que você é o centro daquela situação. Enquanto estiver duelando com você, o alvo sofre penalidade em ações que exijam precisão ou concentração.',
...
// PRESS - HABILIDADES DE LIDERANÇA
// ============================================================
'Orador Intransponível': 'Você conduz discussões com tamanha segurança que hesitação, contradição e pressão emocional raramente conseguem desestabilizá-lo. Ao apresentar uma interpretação plausível, faça uma rolagem de manipulação. Em caso de sucesso, o alvo aceita sua versão como a mais confiável durante quatro turnos ou até receber uma prova incontestável do contrário. Contra Atletas, Bullies e Greasers, você rola duas vezes e utiliza o melhor resultado. Além disso, qualquer tentativa de persuasão, intimidação social, chantagem ou manipulação direcionada contra você precisa superar seu resultado em uma rolagem oposta. Caso o adversário fracasse, você reconhece suas intenções e permanece completamente imune às investidas sociais dele pelo restante da cena.',

'Leitor de Reações': 'Seu olhar treinado identifica alterações mínimas na expressão, na respiração e na postura de qualquer pessoa observada. Depois de acompanhar alguém por um turno completo, você descobre quais emoções ela está tentando esconder e qual assunto provoca medo, raiva, vergonha, insegurança ou desconforto. Você também consegue perceber mentiras comuns sem precisar realizar uma rolagem. Durante os três turnos seguintes, toda tentativa de manipulação contra o alvo pode ser rolada duas vezes, conservando o melhor resultado. Se você já possuir alguma informação comprometedora sobre ele, uma falha comum na rolagem pode ser tratada como sucesso parcial.',

'Retórica Dominante': 'Você controla o ritmo da discussão por meio de perguntas direcionadas, constrangimento público, acusações calculadas e inversões argumentativas. Uma vez por cena, escolha um alvo e realize uma rolagem de manipulação. Em caso de sucesso, ele perde o controle da conversa durante três turnos: não consegue convencer terceiros a agir contra você, suas acusações são recebidas com desconfiança e qualquer tentativa de interrompê-lo apenas reforça a impressão de culpa ou desespero. Se houver pelo menos três testemunhas, sua vitória retórica também prejudica a reputação do alvo pelo restante do dia. Contra Atletas, Bullies e Greasers, o efeito é imediato: seus próprios aliados podem pressioná-lo a se explicar ou exigir que ele recue.',

'Fake News': 'Você transforma fragmentos verdadeiros, fotografias fora de contexto e testemunhos ambíguos em uma narrativa falsa extremamente convincente. A preparação exige dois turnos e um único detalhe capaz de sustentar a história. Depois da divulgação, faça uma rolagem de manipulação para cada facção importante alcançada pela notícia. Os grupos afetados passam a tratar a informação como verdadeira durante todo o restante do dia. Atletas, Bullies e Greasers podem confrontar imediatamente o alvo, romper acordos ou iniciar represálias. Líderes de torcida e Preppies modificam sua postura social e podem isolá-lo. A notícia só perde completamente sua força quando provas concretas são apresentadas publicamente. Mesmo depois de desmentida, você pode escolher uma consequência da mentira que já tenha ocorrido para permanecer irreversível, como uma amizade rompida, uma confiança perdida ou uma rivalidade iniciada.',

'Voz Oficial de Bullworth': 'Quando fala em nome do jornal, você pode obrigar estudantes comuns a conceder espaço, interromper uma abordagem ou ouvir uma declaração. Uma vez por cena, pode encerrar uma discussão social sem necessidade de rolagem, declarar publicamente qual versão será divulgada ou exigir que um estudante se retire de uma reunião, entrevista ou área controlada pela imprensa. Membros comuns de Atletas, Bullies e Greasers não ousam enfrentá-lo diretamente sem a autorização de seus próprios líderes.',

'Intocável da Redação': 'Sua posição editorial e seus contatos entre os professores tornam você praticamente inalcançável pelas regras comuns da escola. Acusações de difamação, provocação, manipulação, chantagem social ou incitação de conflitos são tratadas como disputas relacionadas à liberdade do jornal. Detenções são canceladas, objetos confiscados são devolvidos e ocorrências disciplinares desaparecem antes de serem formalizadas. Quando provas graves são apresentadas, um professor aliado intervém, questiona o procedimento e transfere o caso para uma suposta investigação interna que nunca produz punição concreta. Mesmo quando perde publicamente uma disputa, você sempre pode publicar uma resposta, inverter parte da narrativa e recuperar sua autoridade até o final do dia.',

'Furtividade Social': 'Você consegue permanecer em qualquer ambiente movimentado sem despertar atenção, assumindo naturalmente a postura de alguém convidado, autorizado ou irrelevante demais para ser questionado. Enquanto não iniciar uma agressão ou revelar abertamente suas intenções, pode acompanhar grupos, atravessar reuniões e observar conversas durante uma cena inteira. Atletas, Bullies e Greasers simplesmente deixam de prestar atenção em sua presença depois de alguns instantes. Mesmo quando alguém nota você, a pessoa demora dois turnos para concluir que sua permanência é suspeita, oferecendo tempo suficiente para terminar a escuta ou abandonar o local.',

'Infiltração de Identidade': 'Você domina disfarces, alterações de postura, vocabulário e comportamento social. A preparação exige dois turnos e qualquer elemento visual ligado à identidade pretendida, como uniforme, crachá, prancheta ou equipamento esportivo. O disfarce permanece convincente durante uma cena inteira, permitindo atravessar territórios de facções, áreas administrativas e reuniões fechadas. Pessoas que não conhecem intimamente a identidade representada aceitam sua presença. Mesmo alguém desconfiado precisa observá-lo durante dois turnos completos antes de perceber alguma inconsistência. O disfarce somente é rompido de imediato se você revelar conhecimento impossível, agir de maneira completamente incompatível com o papel ou for identificado por alguém que o conheça pessoalmente.',

'Escuta de Longo Alcance': 'Como parte de seu pacote, você recebe um gravador direcional portátil, desenvolvido para captar conversas distantes e filtrar parte dos ruídos de corredores, arquibancadas e áreas externas. O instrumento pode registrar vozes através de portas comuns, de janelas abertas ou em meio a multidões, desde que você permaneça relativamente imóvel durante um turno completo. As gravações preservam falas, nomes e entonações com clareza suficiente para serem reproduzidas posteriormente. Você pode manter até três gravações importantes armazenadas simultaneamente. Uma gravação autêntica é considerada prova material, podendo quebrar manipulações, pressionar testemunhas ou sustentar uma publicação. Somente paredes espessas, ruído extremo ou equipamentos deliberadamente preparados para bloquear captação impedem a escuta.',

'Bajulação Estratégica': 'Você identifica aquilo que cada pessoa mais deseja ouvir e utiliza elogios calculados para conquistar confiança. Faça uma rolagem de manipulação após conversar com o alvo por pelo menos um turno. Em caso de sucesso, ele passa a tratá-lo como alguém confiável durante quatro turnos, permite sua permanência no local e responde honestamente a até duas perguntas que não o incriminem de maneira evidente. Atletas, Bullies e Greasers também podem revelar espontaneamente uma informação adicional na tentativa de impressioná-lo. Líderes de torcida e Preppies exigem a rolagem normal. Nerds apenas colaboram quando a aproximação vier acompanhada de interesse real ou provas verificáveis.',
